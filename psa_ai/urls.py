...
urlpatterns = [
    ...
    path('triage/<str:ticket_number>/', views.generate_triage, name='generate_triage'),
    ...
    path('suggestion/<int:pk>/triage-feedback/', views.triage_feedback, name='triage_feedback'),
